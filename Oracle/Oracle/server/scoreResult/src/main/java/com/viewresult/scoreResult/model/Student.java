...
public class Student {
	...
	public Student(long id, float maths, float literatures, float history, float geography, float physics,
			float biology, float foreignLang, float civicEdu, float chemistry) {
		super();
		this.id = id;
		this.maths = maths;
